...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'residence',array('rows'=>6, 'cols'=>50)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'answers_n'); ?>
		<?php echo $form->textField($model,'answers_n'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'followers_n'); ?>
		<?php echo $form->textField($model,'followers_n'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'anonym_questions'); ?>
		<?php echo $form->textField($model,'anonym_questions'); ?>
	</div>
